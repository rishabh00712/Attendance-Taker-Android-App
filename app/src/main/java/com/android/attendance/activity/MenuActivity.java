...
public class MenuActivity extends Activity {
	...
	Button sortattendancePerStudent;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sortattendancePerStudent=(Button)findViewById(R.id.sortattendancePerStudentButton);
		sortattendancePerStudent.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent intent = new Intent(MenuActivity.this,SortAttendanceActivity.class);
				startActivity(intent);
		...
		chartButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent intent = new Intent(MenuActivity.this,ViewChartActivity.class);
				startActivity(intent);
		...
		barchartButton.setOnClickListener(new OnClickListener() {
