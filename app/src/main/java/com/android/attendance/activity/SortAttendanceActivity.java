...
public class SortAttendanceActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        attendanceBeanList=((ApplicationContext)SortAttendanceActivity.this.getApplicationContext()).getAttendanceBeanList();


//        Collections.sort(attendanceBeanList, new Comparator<AttendanceBean>() {
//            @Override
//            public int compare(AttendanceBean bean1, AttendanceBean bean2) {
//                // Compare the attendance_session_id of the two beans
//                return bean1.getAttendance_session_id().compareTo(bean2.getAttendance_session_id());
//            }
//        });
        ...
        Collections.sort(attendanceBeanList, new Comparator<AttendanceBean>() {
            ...
            public int compare(AttendanceBean bean1, AttendanceBean bean2) {
                // Compare the attendance_session_id of the two beans
                return Integer.compare(bean1.getAttendance_session_id(), bean2.getAttendance_session_id());
            }
        });
        ...
        for(AttendanceBean attendanceBean : attendanceBeanList)
        {
            ...
            DBAdapter dbAdapter = new DBAdapter(SortAttendanceActivity.this);
